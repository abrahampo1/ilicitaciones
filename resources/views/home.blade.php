...
@section('meta_description', 'Panel de inteligencia de licitaciones. Analiza adjudicaciones, organismos y empresas del
    sector público en tiempo real.')
    ...
    <div class="relative mb-12">
        ...
        <div class="relative">
            <p class="text-neutral-500 text-xs md:text-sm mb-2">Hasta el
                {{ $stats['latestDate'] ? \Carbon\Carbon::parse($stats['latestDate'])->format('d/m/Y H:i') : 'N/A' }}</p>
            <h2
                class="text-3xl md:text-5xl font-light mb-8 bg-gradient-to-r from-neutral-100 to-neutral-400 bg-clip-text text-transparent">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div
                    class="group p-6 bg-gradient-to-br from-neutral-800/80 to-neutral-900 border border-neutral-700/50 rounded-2xl hover:border-emerald-500/30 transition-all duration-300">
                ...
                <div
                    class="group p-6 bg-gradient-to-br from-neutral-800/80 to-neutral-900 border border-neutral-700/50 rounded-2xl hover:border-teal-500/30 transition-all duration-300">
                    ...
                    <p class="text-xl md:text-2xl font-mono text-teal-400">
                        {{ number_format($stats['totalImporte'], 2, ',', '.') }}€</p>
                </div>
                <div
                    class="group p-6 bg-gradient-to-br from-neutral-800/80 to-neutral-900 border border-neutral-700/50 rounded-2xl hover:border-cyan-500/30 transition-all duration-300">
                ...
                <div
                    class="group p-6 bg-gradient-to-br from-neutral-800/80 to-neutral-900 border border-neutral-700/50 rounded-2xl hover:border-sky-500/30 transition-all duration-300">
            ...
            <div class="relative bg-neutral-900/90 backdrop-blur border border-neutral-700/50 rounded-2xl p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('empresas') }}"
                        class="text-xs text-neutral-500 hover:text-emerald-400 transition-colors">
                        Ver todas →
                    </a>
                </div>
            ...
            <div class="relative bg-neutral-900/90 backdrop-blur border border-neutral-700/50 rounded-2xl p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('organismos') }}"
                        class="text-xs text-neutral-500 hover:text-cyan-400 transition-colors">
                        Ver todos →
                    </a>
                </div>
