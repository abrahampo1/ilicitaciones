...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', 'Plataforma avanzada para la búsqueda, visualización y análisis de licitaciones del sector público en España. Información detallada de organismos y adjudicaciones.')">
    ...
    <meta property="og:description"
        content="@yield('meta_description', 'Plataforma avanzada para la búsqueda, visualización y análisis de licitaciones del sector público en España.')" />
    ...
    <meta property="twitter:title"
        content="@yield('meta_title', 'I-Licitaciones - Buscador de Licitaciones del Estado')" />
    ...
    {{-- Feed RSS --}}
    <link rel="alternate" type="application/rss+xml" title="I-Licitaciones · Análisis"
        href="{{ route('analisis.feed') }}" />
...
<body class="bg-neutral-900 text-neutral-100 font-serif min-h-screen flex flex-col">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5FZDH2L7" height="0" width="0"
    ...
    <div class="flex-1 w-full text-neutral-100">
        <header class="border-b border-neutral-800">
            <div
                class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <a href="{{ route('home') }}"
                    class="text-xl font-light tracking-tight hover:text-neutral-300 transition-colors">
                    <span
                        class="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent font-medium">I</span>-Licitaciones
                </a>
    ...
    <footer class="border-t border-neutral-800 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
                <p>Datos de contratación pública en España · <a href="mailto:{{ config('periodico.contacto') }}"
                        class="hover:text-neutral-300 transition-colors">{{ config('periodico.contacto') }}</a></p>
                <nav class="flex gap-4" aria-label="Navegación del pie de página">
                    ...
                    <a href="{{ route('analisis.index') }}"
                        class="hover:text-neutral-300 transition-colors">Análisis</a>
