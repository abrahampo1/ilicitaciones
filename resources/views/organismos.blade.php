...
@section('contenido')
    ...
    <div class="relative mb-10">
        ...
        <div class="relative">
            ...
            <!-- Search Form -->
            <form action="{{ route('organismos') }}" method="GET" class="max-w-lg" role="search" aria-label="Buscar organismos">
                <div class="relative group">
                    ...
                    <div class="relative flex items-center bg-neutral-900 rounded-xl">
                        ...
                        >
                        @if(request('search'))
                            <a href="{{ route('organismos') }}" class="pr-4 text-neutral-400 hover:text-neutral-300 transition-colors">
